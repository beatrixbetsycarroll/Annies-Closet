...
ActiveRecord::Schema.define(version: 20151130191306) do
  ...
  add_index "item_types", ["item_id"], name: "index_item_types_on_item_id"
  add_index "item_types", ["type_id"], name: "index_item_types_on_type_id"
